...
function signInForm(){
  ...
  <div class="container loginContainer">
        ...
        <p><a href="">Forgot your password?</a> Not a member, <a href="" class="signUp2">SignUp</a>  </p>
      </div>
...
$(function(){
  ...
  $(".mainContainer").on('click','.signUp2', function(event){
    event.preventDefault();
    $(".mainContainer").html(signUpForm)
  })

  $(".contactContainer").on('click', '.contactUs', function(event){
